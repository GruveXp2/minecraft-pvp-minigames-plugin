...
import gruvexp.bbminigames.twtClassic.ability.AbilityType.Companion.fromItem
import gruvexp.bbminigames.twtClassic.ability.PotionAbility
import gruvexp.bbminigames.twtClassic.ability.abilities.*
import gruvexp.bbminigames.twtClassic.ability.abilities.LingeringPotionTrap.Companion.getCloudOwner
import gruvexp.bbminigames.twtClassic.ability.abilities.LingeringPotionTrap.Companion.giveRandomEffect
...
class AbilityListener : Listener {
    ...
    fun onProjectileLaunch(e: ProjectileLaunchEvent) {
        ...
        if (e.entity is Arrow) {
            ...
            if (fromItem(itemInMainHand) == AbilityType.SPLASH_BOW) {
    ...
    fun onPotionAbilityUse(e: PlayerItemConsumeEvent) {
        ...
        val type = fromItem(e.item) ?: return
    ...
    fun onCloudApply(e: AreaEffectCloudApplyEvent) {
        val cloud = e.entity
        val cloudOwningBp = getCloudOwner(cloud) ?: return
    ...
    fun onAbilityDrop(e: PlayerDropItemEvent) {
        val p = e.player
        val bp = BotBows.getBotBowsPlayer(p) ?: return
        val type = fromItem(e.itemDrop.itemStack) ?: return
    ...
    fun onSwing(e: PlayerAnimationEvent) { // left clicking but not hitting anything
        val p = e.player
        val bp = BotBows.getBotBowsPlayer(p) ?: return
        val type = fromItem(p.inventory.itemInMainHand) ?: return
    ...
    companion object {
        ...
        fun onSlap(
            ...
            val type = fromItem(weapon) ?: return
