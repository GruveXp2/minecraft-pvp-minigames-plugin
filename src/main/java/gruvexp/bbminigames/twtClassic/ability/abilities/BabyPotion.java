...
public class BabyPotion extends PotionAbility {
    ...
    public void applyPotionEffect(Set<BotBowsPlayer> players) {
        ...
        players.forEach(bp -> bp.avatar.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, DURATION * 15, 4))); // 75% of the duration will be given to other players on the team
