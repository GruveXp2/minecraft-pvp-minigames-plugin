...
class SteamPunkGame(settings: Settings) : BotBowsGame(settings) {
    ...
    init {
        ...
        rotors = setOf(
            Rotor(1, Location(world, -332.0, 39.0, -391.0), "copper_rotor", 50f, 3),
            Rotor(2, Location(world, -336.0, 39.0, -391.0), "copper_rotor", 50f, 3),
            Rotor(3, Location(world, -344.0, 39.0, -395.0), "copper_rotor", 50f, 3),
            Rotor(4, Location(world, -344.0, 39.0, -392.0), "copper_rotor", 50f, 3),
            Rotor(5, Location(world, -343.0, 39.0, -381.0), "copper_rotor", 50f, 3),
            Rotor(6, Location(world, -343.0, 39.0, -372.0), "copper_rotor", 50f, 3),
            Rotor(1, Location(world, -332.0, 39.0, -362.0), "copper_rotor_exposed", 37f, 4),
            Rotor(2, Location(world, -336.0, 39.0, -362.0), "copper_rotor_exposed", 37f, 4),
            Rotor(3, Location(world, -344.0, 39.0, -358.0), "copper_rotor_exposed", 37f, 4),
            Rotor(4, Location(world, -344.0, 39.0, -361.0), "copper_rotor_exposed", 37f, 4),
            Rotor(5, Location(world, -351.0, 39.0, -389.0), "copper_rotor_exposed", 37f, 4),
            Rotor(6, Location(world, -358.0, 39.0, -391.0), "copper_rotor_exposed", 37f, 4),
            Rotor(7, Location(world, -358.0, 39.0, -394.0), "copper_rotor_exposed", 37f, 4),
            Rotor(1, Location(world, -351.0, 39.0, -364.0), "copper_rotor_weathered", 25f, 6),
            Rotor(2, Location(world, -357.0, 39.0, -359.0), "copper_rotor_weathered", 25f, 6),
            Rotor(3, Location(world, -357.0, 39.0, -362.0), "copper_rotor_weathered", 25f, 6),
            Rotor(4, Location(world, -364.0, 39.0, -389.0), "copper_rotor_weathered", 25f, 6),
            Rotor(5, Location(world, -371.0, 39.0, -395.0), "copper_rotor_weathered", 25f, 6),
            Rotor(6, Location(world, -371.0, 39.0, -392.0), "copper_rotor_weathered", 25f, 6),
            Rotor(7, Location(world, -372.0, 39.0, -381.0), "copper_rotor_weathered", 25f, 6),
            Rotor(1, Location(world, -363.0, 39.0, -364.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(2, Location(world, -371.0, 39.0, -358.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(3, Location(world, -371.0, 39.0, -361.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(4, Location(world, -372.0, 39.0, -372.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(5, Location(world, -379.0, 39.0, -391.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(6, Location(world, -383.0, 39.0, -391.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(7, Location(world, -383.0, 39.0, -362.0), "copper_rotor_oxidized", 18f, 8),
            Rotor(8, Location(world, -379.0, 39.0, -362.0), "copper_rotor_oxidized", 18f, 8),
        )
    }
